                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="profile3" class="tab-pane">
                                                <form action="head/saveSys3.do" name="Form3" id="Form3" method="post">
                                                    <input type="hidden" value="${pd.PLsmsSound }" id="PLsmsSound" name="PLsmsSound" />
                                                    <table class="table table-striped table-bordered table-hover">
                                                        <tr>
                                                            <td style="text-align: center;" colspan="100">
                                                                微信接口配置
                                                            ...
                                                            <td colspan="100" class="center">
                                                                <div class="col-sm-9">
                                                                    <label style="float:left;padding-left: 1px;padding-top:7px;">
                                                                        <input name="form-field-radio2" type="radio" class="ace"  <c:if test="${pd.PLsmsSound == '0' }">checked="checked"</c:if> onclick="setPLsmsSoundType('0');"/>
                                                                        <span class="lbl">静音</span>
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                        <input name="form-field-radio2" type="radio" class="ace"  <c:if test="${pd.PLsmsSound == '1' }">checked="checked"</c:if> onclick="setPLsmsSoundType('1');"/>
                                                                        <span class="lbl">歪歪音效</span>
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                        <input name="form-field-radio2" type="radio" class="ace"  <c:if test="${pd.PLsmsSound == '2' }">checked="checked"</c:if> onclick="setPLsmsSoundType('2');"/>
                                                                        <span class="lbl">美女音效</span>
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                        <input name="form-field-radio2" type="radio" class="ace" <c:if test="${pd.PLsmsSound == '3' }">checked="checked"</c:if> onclick="setPLsmsSoundType('3');"/>
                                                                        <span class="lbl">飞信音效</span>
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                        <input name="form-field-radio2" type="radio" class="ace" <c:if test="${pd.PLsmsSound == '4' }">checked="checked"</c:if> onclick="setPLsmsSoundType('4');"/>
                                                                        <span class="lbl">IOS短信音效</span>
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                        <input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3" <c:if test="${pd.PLsmsSound == '5' }">checked="checked"</c:if> onclick="setPLsmsSoundType('5');"/>
